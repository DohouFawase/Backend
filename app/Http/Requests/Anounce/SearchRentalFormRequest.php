 ...
 */
class SearchRentalFormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            // Spécifique location
            'periodicity' => ['nullable', 'in:day,night,week,month'],
            'max_deposit_months' => ['nullable', 'integer', 'min:0'],
    ...
    public function messages(): array
    {
        return [
            ...
            'periodicity.in' => 'La périodicité doit être : day, night, week ou month.',
