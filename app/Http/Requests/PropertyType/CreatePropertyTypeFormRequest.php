...
class CreatePropertyTypeFormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            //
             'name' => ['required', 'string', 'unique:property_types,name', 'min:1', 'max:100'], 
        ];
    }
    ...
    {
        return [
          'name.required' => 'Le Type de Bien est obligatoire.',
