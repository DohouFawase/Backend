...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('ads', function (Blueprint $table) {
            ...
            // Ajout de la FK de version active après les autres tables pour éviter des erreurs cycliques,
            // ou on peut l'ajouter ici en attendant que la table `ad_versions` soit créée plus tard.
            // On la laissera dans la migration de `ad_versions` pour la liaison inverse.
        });
    }
